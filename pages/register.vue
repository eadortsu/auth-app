...
color='primary' block :loading="isLoading" :disabled="isLoading"
                       @click='register()' >Start coding now</v-btn>
              </v-card-actions>
